...
/************* METHODS ************************************************************************************************/
    ...
    private String getAppointmentInfo(){
        String xml = "<appointment date='" + this.appt.getApptdate() + "' id='" + this.appt.getId() + "' "
                    + "time='" + this.appt.getAppttime() + "'><uri>"
                    + "http://localhost:8080/LAMSService/resources/Services/Appointments/" + this.appt.getId() + "</uri>";
        return xml;
    ...
    private String getPatientInfo(){
        ...
        String xml =  "<patient id='" + patient.getId() + "'><uri/><name>" + patient.getName() 
